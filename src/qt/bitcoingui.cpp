    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aspire Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aspire address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aspire: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aspire Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aspire Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aspire"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aspire addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aspire addresses"));
    ...
    openAction->setStatusTip(tr("Open a aspire: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aspire Core help message to get a list with possible Aspire command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Aspire Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aspire network", "", count));
}
...
{
    QString strTitle = tr("Aspire Core"); // default title
