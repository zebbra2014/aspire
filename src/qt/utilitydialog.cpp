    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Aspire Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Aspire Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  aspire-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Aspire Core is shutting down...") + "<br /><br />" +
