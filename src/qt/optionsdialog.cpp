    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ASPIRE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ASPIRE-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    /* Nitrosend Rounds */
    mapper->addMapping(ui->nitrosendRounds, OptionsModel::NitrosendRounds);
