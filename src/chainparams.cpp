...
public:
    CMainParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 76);                    // aspire addresses start with 'X'
...
public:
    CTestNetParams() {
        ...
        *///legacy seeders
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(139);                    // Testnet aspire addresses start with 'x' or 'y'
