...
// Copyright (c) 2014-2015 The Aspire Core developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:6180", "127.0.0.1", 6180));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6180", "127.0.0.1", 6180));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6180", "::ffff:127.0.0.1", 6180));
    BOOST_CHECK(TestSplitHost("[::]:6180", "::", 6180));
    BOOST_CHECK(TestSplitHost("::6180", "::6180", -1));
    BOOST_CHECK(TestSplitHost(":6180", "", 6180));
    BOOST_CHECK(TestSplitHost("[]:6180", "", 6180));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6180", "127.0.0.1:6180"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6180", "[::]:6180"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
