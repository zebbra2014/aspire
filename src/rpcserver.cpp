...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Aspire features */
    { "aspire",               "masternode",             &masternode,             true,      true,       false },
    { "aspire",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "aspire",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "aspire",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "aspire",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "aspire",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "aspire",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "aspire",               "nitrosend",               &nitrosend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use aspired, or the -server option to aspire-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> aspire-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6179/\n";
}
